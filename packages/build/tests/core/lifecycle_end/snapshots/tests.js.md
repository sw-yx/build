...
> Snapshot 1
    ...
    ␊
    > Resolved config␊
      config: lifecycle: onBuild: node --invalid␊
          onEnd: echo onEnd␊
          onError: echo onEnd␊
    ␊
    > Context␊
...
> Snapshot 1
    ...
    ␊
    > Resolved config␊
      config: lifecycle: onBuild: node --version␊
          onEnd: echo onEnd␊
    ␊
    > Context␊
      production␊
...
> Snapshot 1
    ...
    ␊
    ┌───────────────────────────────────────────────────┐␊
    │ 3. Running onEnd command from /file/path │␊
    └───────────────────────────────────────────────────┘␊
    ␊
    Plugin invalid␊
    ␊
    ┌─────────────────────────────────────────────────┐␊
    │ 4. Running onEnd command from /file/path │␊
    └─────────────────────────────────────────────────┘␊
    ␊
    Plugin valid␊
    ␊
...
> Snapshot 1
    ...
    ␊
    ┌─────────────────────────────────────────────┐␊
    │ 3. Running onError command from /file/path │␊
    └─────────────────────────────────────────────┘␊
    ␊
    TestError␊
    test␊
...
> Snapshot 1
    ...
    ␊
    ┌───────────────────────────────────────────────────┐␊
    │ 4. Running onError command from /file/path │␊
    └───────────────────────────────────────────────────┘␊
    ␊
    Command failed with exit code 9: node --invalid␊
    ␊
